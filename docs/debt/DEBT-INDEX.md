...
| D4 | Spawn + SoccerPitch world-space resolution | deferred-scope | W-ENT | W-ENT (spawn / soccer service) | [worldspace-resolution-services.md](worldspace-resolution-services.md) | OPEN |
...
| T4 | `walk_grid` type-level totality (proven-present `MapId`) | tech-debt | W-ENT | W-ENT (Atlas-minted map handle) | [spatial-foundation-followups.md](spatial-foundation-followups.md) | OPEN |
